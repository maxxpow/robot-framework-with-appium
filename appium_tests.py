...
class AppiumTests(unittest.TestCase):
    def setUp(self):
        ...
        desired_caps['appiumVersion'] = '1.0.2'
    ...
    def test_background_app(self):
        ...
        go=self.driver.background_app(1)
        print "this is background app",go
        sleep(5)
        el = self.driver.find_element_by_xpath("//*[starts-with(@text,'Animation')]")
...
if __name__ == "__main__":
    ...
    #print AppiumTests.test_current_package(suite)
    #print suite.driver.background_app()